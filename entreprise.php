	...
	<aside>
			...
			<ul style="list-style-type:none">
				<li id="li1"><a class="soulign" href="#partie1">Une popularité grandissante</a>
						<ul style="list-style-type:none">
							<li id="li2"><a href="#partie1_sous_partie1">Entreprise en expension</a></li>
							<li id="li2"><a href="#partie1_sous_partie2">À proximité de la communauté</a></li>
		...
		<div class="corps center" id="paddingPasFlo">
			<div class="marginleft">
				<h1 id="partie1">Une expension à travers une popularité en forte croissance</h1>
					<h2 id="partie1_sous_partie1">Une entreprise grandissante</h2>
						<p>À ses débuts, la société est une petite entreprise créée par trois employés de Paypal : Chad Hurley, Steve Chen et Jawed Karim. Si petite qu’elle tient dans un appartement au dessus d’un restaurant !</p>

						<div class="image un">
							<img src="Alexandre/images/ytbqg.jpg" alt="">
						</div>

						<p>Dès son lancement en février 2005, YouTube connaît une popularité très forte. En 1 an, le site revendique déjà plus de 35 millions de vidéos visionnées par jour. Sa popularité la conduit vers un développement très rapide; rachetée par le géant Google le 9 octobre 2006,
						cela ne veut dire qu'une chose : Youtube a l’intention de devenir une plaque tournante dans l’hébergement de vidéos. L'entreprise qui continue de fortement grandir a alors besoin de meilleurs équipements : elle change son quartier général pour un espace beaucoup plus grand avec de bien meilleurs équipements à San Bruno en Californie.
						...
						<div class="image deux">
							<img src="Alexandre/images/ytbqgafter.jpg" alt="">
						</div>

						<p>YouTube se lance internationalement dès 2007 en Europe et dans le monde entier, et particulièrement le 19 juin en France. Elle entre alors en concurrence avec les hébergeurs du moments comme Dailymotion qui seront rapidement engloutis. Son influence
							ne se limite pas qu'à un simple hébergeur de vidéos : l'entreprise développe également de nombreuses choses telles que des ambassades afin de promouvoir leurs "produits", les youtubers etc dans différentes métropoles telles que Paris et Londres.</p>

					<h2 id="partie1_sous_partie2">Un accroissement par une proximité envers sa communauté</h2>
						...
						<div class="image trois">
						 <img src="Alexandre/images/ytbspacemumbaii.jpg" alt="">
					</div>
					...
					<h2 id="partie1_sous_partie3">L'entreprise de nos jours</h2>
						...
						<div class="image quatre">
							<img src="Alexandre/images/ytbgolf.jpg" alt="">
						</div>

						<div class="image cinq">
						 <img src="Alexandre/ytbpiscine.jpg" alt="">
					  </div>

						<div class="image six">
							<img src="Alexandre/images/ytbhall.jpg" alt="">
						</div>

						<p>Youtube est présent dans 79 pays (6 avril 2015) et disponible dans 76 langues. Il recueille 95 % de la population Internet mondiale : son pari est rempli, le géant Google a fait de Youtube de très loin la première plateforme d’hébergement de vidéos au monde.</p>

				<h2 id="partie2">Le DATA Center : au coeur de la gestion des données</h2>

					<p>Youtube est un site web d’hébergement de vidéos dans lequel l’utilisateur, en tant que spectateur ou créateur peut faire de nombreuses choses. Gérer les données des utilisateurs est donc crucial : il faut pouvoir organiser, stocker et traiter les données de milliards d’utilisateurs. Le meilleur moyen, à ce jour, reste l’utilisation des data center qui est un outil indispensable.</p>

					<h2 id="partie2_sous_partie1">Définition</h2>
						...
						<p>Il s’agit d’une infrastructure qui est composée d’espaces de stockage de données, de réseaux de serveurs ainsi que tout ce dont ces éléments ont besoin pour fonctionner : câbles, routeurs et même systèmes de distribution d’énergie mais également de refroidissement. Effectivement, ces data centers sont très gourmands en électricité et chauffent énormément.<p>
							...
							<div class="image sept">
							   <img src="Alexandre/images/ytbdatacenter1.jpg" alt="">
							</div>

							<div class="image huit">
							  <img src="Alexandre/images/ytbdatacenter2.jpg" alt="">
						  </div>

						  <div class="image neuf">
								<img src="Alexandre/images/ytbdatacenter3.jpg" alt="">
							</div>


					<h2 id="partie2_sous_partie2">Localisation</h2>

						<p>Google est une énorme boîte qui de ce fait possède beaucoup de data centers à travers le monde. En 2012, on dénombre environ 36 data centers.
							...
							<div class="image dix">
									<img src="Alexandre/images/local1.jpg" alt="">
							</div>

							<div class="image onze">
									<img src="Alexandre/images/local2.jpg" alt="">
							</div>

							<div class="image douze">
									<img src="Alexandre/images/local3.jpg" alt="">
							</div>
				 	...
				 	<h2 id="partie2_sous_partie3">Consommation</h2>
						...
						<div class="image treize">
								<img src="Alexandre/images/ytbdatacenter4.jpg" alt="">
						</div>
