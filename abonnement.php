...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Abonnement</h3>
			<p class="indent foncFont">Se bouton permet de s'abonner à l'auteur de la vidéo que l'on regarde et également voir le nombre d'abonné de ce dernier. La cloche à côté, permet d'activer ou de desactiver les notifications par e-mail et smartphone à chaque fois que le <i>youtuber</i> sort une nouvelle vidéo.</p>
		</div>
		<div id="lien">
