...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Titre</h3>
			<p class="indent foncFont">Le titre de la vidéo est défini par l'auteur de cette dernière. Juste sous le titre on peut voir le nombre de vues. Ici, plus de 16 millions de vues, ce qui est vraiment énorme.</p>
		</div>
		<div id="lien">
