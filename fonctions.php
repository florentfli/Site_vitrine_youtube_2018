...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Navigation</h3>
			<p class="indent foncFont">Ce bouton donne un accés rapide avec un menu latéral et permet de se rendre facilement sur la page "Abonnement", "Acceuil" ou encore la page "Tendances".</p>
		</div>
		<div id="lien">
