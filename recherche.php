...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Barre de recherche</h3>
			<p class="indent foncFont">C'est une barre de recherche rapide disponible sur toutes les pages du site. Elle permet d'effectuer des recherches suivant différents paramèttres comme par exemple, le nombre de vue, la date de mise en ligne ou encore la durée de la vidéo.</p>
		</div>
		<div id="lien">
