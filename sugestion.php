...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Recommandation</h3>
			<p class="indent foncFont">Cette colonne de vidéo situer à droite du lecteur ou en dessous en "Theatre Mode", permet de naviguer entre différentes vidéos qui devrait nous interesser suite à nos diverses recherche, abonnement et historique grâce à un algorithme complexe.</p>
			<p class="indent foncFont">Par exemple ici, les recommandations sont des vidéos du même <i>youtuber</i> que la vidéos que je suis entrain de regarder puisque je suis abonné à la chaine du <i>youtuber</i>.</p>
		</div>
		<div id="lien">
