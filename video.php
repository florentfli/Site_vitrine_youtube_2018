...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Lecteur vidéo</h3>
			<p class="indent foncFont">Le lecteur vidéo de YouTube est très bien pensé puisqu'il est sobre et fonctionnel. En effet, il permet des interactions créateur/spectateur avec notament des sondages, des annotations disponibles directement à droite du lecteur. Ici, le "¡" situé en haut à droite, signifie qu'il y a une annotation disponible au clique.</p>
		</div>
		<div id="lien">
