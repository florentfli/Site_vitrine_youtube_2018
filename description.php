...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Description</h3>
			<p class="indent foncFont">La description est l'endroit où l'auteur peut laisser un message attaché à sa vidéo, comme par exemple donnez les liens de ses réseaux sociaux, ou encore un message pour sa communauté.</p>
		</div>
		<div id="lien">
