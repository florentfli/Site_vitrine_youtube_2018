...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Barre de progression</h3>
			<p class="indent foncFont">Cette barre semblable à tout celle des lecteurs vidéos classiques à une exception près : elle propose une prévisualisation du momment que vous survolez avec la sourie. Très pratique pour chercher un endroit précis, comme dans une longue vidéo par exemple.</p>
