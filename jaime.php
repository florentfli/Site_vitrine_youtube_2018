...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont"><i>Les pouces bleus et rouges</i></h3>
			<p class="indent foncFont">"Les pouces" sont un moyen mis en place afin de permettre à la communauté d'évaluer positivement ou négativement le contenu de la vidéo en question. Ils sont également un moyen de référencement dans l'algorithme de YouTube.</p>
		</div>
		<div id="lien">
