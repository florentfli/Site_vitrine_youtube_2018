...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Fonctionnalité de lecture</h3>
			<p class="indent foncFont">Ces trois boutons servent dans l'ordre à : faire play/pause, aller à la vidéo suivante, changer le volume.</p>
		</div>
		<div id="lien">
