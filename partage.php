...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Le partage</h3>
			<p class="indent foncFont">Comme les <i>youtubers</i> ne vivent qu'à travers de leur communauté, il est important pour eux de pouvoir partager leur contenu. C'est pour ça que YouTube a ajouté cette fonctionnalité. Elle permet de partager une vidéo à n'importe qui et sous de multiple formes : mail, facebook, twitter, ou lien.</p>
		</div>
		<div id="lien">
