...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Chaine du <i>youtuber</i></h3>
			<p class="indent foncFont">Cette endroit de la page permet d'acceder à la chaîne YouTube de l'auteur de la vidéo mais aussi de voir la date de publication de cette dernière. Le symbole  "✓"  à droite du pseudonyme, signifie que la chaîne a été valider par YouTube en tant que chaîne "originale" et non comme une pâle copie.</p>
		</div>
		<div id="lien">
