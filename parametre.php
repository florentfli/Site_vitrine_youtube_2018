...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Paramètre  de lecture</h3>
			<p class="indent foncFont">Ces fonctionnalitées vont vous permettre d'activer les sous titres, changer la qualité et la vitesse de lecture de la vidéo, mais également de passer en mode "plein écran" ou "théatre".</p>
		</div>
		<div id="lien">
