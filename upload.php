...
<body>
	...
	<div class="corps" id="padding">
		<div class="textFonction">
			<h3 class="foncFont">Bouton d'<i>upload</i></h3>
			<p class="indent foncFont">Ce bouton est un accés rapide à la page de mise en ligne des vidéos. Il est présent sur toutes les pages du site.</p>
		</div>
		<div id="lien">
